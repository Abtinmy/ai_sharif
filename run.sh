...
cd ../server
java -jar hideandseek-0.1.1.jar --first-team=../AIC22-Client-Python2/dist/client --second-team=../AIC22-Client-Python/dist/client resources/game.yml resources/map.json
